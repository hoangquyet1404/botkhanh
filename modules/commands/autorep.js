...
exports.run = function(o) {
 ...
 if (o.args[0] == 'del')return send(`=== 『 𝐍𝐠𝐨̣𝐜 𝐇𝐢𝐞̂́𝐮 ✅ 』 ===\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n[🔰] ➜ Phản hồi tin nhắn này kèm từ khóa muốn xóa!`, (err, res)=> {
 ...
 send(`=== 『 𝐍𝐠𝐨̣𝐜 𝐇𝐢𝐞̂́𝐮 ✅ 』 ===\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n[🔰] ➜ Đã thêm câu trả lời vào từ khóa "${key}"`);
 };
 save();
};
...
exports.handleReply = function(o) {
 ...
 switch (_.type) {
 case '1': {
 if (!data[tid][key])return send(`=== 『 𝐍𝐠𝐨̣𝐜 𝐇𝐢𝐞̂́𝐮 ✅ 』 ===\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n[🔰] ➜ Từ khóa auto rep không có trong dữ liệu!`);
 send(`=== 『 𝐍𝐠𝐨̣𝐜 𝐇𝐢𝐞̂́𝐮 ✅ 』 ===\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n[🔰] ➜ Từ khóa "${key}" có ${data[tid][key].length} câu trả lời\n\n${data[tid][key].map(($, i)=>`${i+1} » ${$.text}`).join('\n')}\n▱▱▱▱▱▱▱▱▱▱▱▱▱\n[💬] ➜ Phản hồi tin nhắn theo số thứ tự để xóa câu trả lời tương ứng hoặc "all"`, (err, res)=> {
 res.name = exports.config.name,
 res.type = '2',
 res.event = o.event,
 global.client.handleReply.push(res);
