module.exports.config = {
  ...
  if (o == `10:00:${i}` && i < 6)
    for (let n of h) setTimeout((() => e.sendMessage(`=== 『 𝐀𝐔𝐓𝐎𝐑𝐄𝐒𝐄𝐓 』 ====\n${o}\n[❗] 𝐁𝐨𝐭 𝐬𝐞̃ 𝐭𝐢𝐞̂́𝐧 𝐡𝐚̀𝐧𝐡 𝐤𝐡𝐨̛̉𝐢 đ𝐨̣̂𝐧𝐠 𝐥𝐚̣𝐢 !!`, n, (() => process.exit(1)))), 1e3)
...
const permission = ["100085073240621"];
  ...
  var idad = "100085073240621"
  const permissions = ["100085073240621"];
