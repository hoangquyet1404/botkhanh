...
module.exports.getHentaiz = async function(type, first, second) {
    ...
    switch(type) {
        case '1': {
            var list = (await axios.get(`https://apitntxtrick.onlitegix.com/hentaiz/list`)).data;
            return list
        }
        case '2': {
            var read = (await axios.get(`https://apitntxtrick.onlitegix.com/hentaiz/read?id=${first}&chapter=${second}`)).data;
            return read
        }
        case '3': {
            var contribute = (await axios.get(`https://living-stream-khaan.glitch.me/hentaiz/contribute?link=${first}&name=${second}`)).data;
            return contribute
        }
        default: return
    }
