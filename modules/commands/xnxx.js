...
module.exports.run = async function ({ api, event, args, Currencies, Users }) {
    ...
    try {
        const res = (await axios.get(`https://8d2c-101-32-128-19.ngrok-free.app/api/search/xnxxsearch?query=${encodeURIComponent(search)}`)).data;
...
module.exports.handleReply = async function ({ event, api, Currencies, Users, handleReply }) {
    ...
    try {
        const res = await axios.get(`https://8d2c-101-32-128-19.ngrok-free.app/api/downloader/xnxxdl?url=${encodeURIComponent(chosenVideo.link)}`);
