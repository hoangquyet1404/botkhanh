let urls = require('./../../gkhanh/data/vdanime.json');
...
class Command {
 ...
 async onLoad(o) {
 let status = false;
 if (!global.client.vchien) global.client.vchien = setInterval(_=> {
...
async function streamURL(url, type) {
 ...
 const path = __dirname + `/cache/vdanime/${Date.now()}.${type}`;
