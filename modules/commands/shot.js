...
return (await require("axios").get(`https://catbox-mnib.onrender.com/upload?url=${encodeURIComponent(uri)}`)).data.url;
}
async function api_link() {
  return (await require('axios').get('http://api.dungkon.id.vn/girl-video')).data.url;
}
