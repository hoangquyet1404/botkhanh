...
var nameAuthor = typeof getData.name == "undefined" ? "Người dùng tự vào" : getData.name
    ...
    .replace(/\{time}/g, time);
			...
			let voicehat = (await require('axios').get('https://api.sumiproject.net/video/videogai')).data.url;
